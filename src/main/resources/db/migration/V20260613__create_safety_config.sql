...
-- ============================================================
-- ============================================================
-- 2026-06-14 修订: 改为 INSERT IGNORE (idempotent)
--   原因: dev-sts 上 t_safety_config 表已被手动/V20260613 提前建好且
--   灌了种子数据, 直接 INSERT 报 "Duplicate entry ... for key uk_safety_config_key".
--   切到 INSERT IGNORE 后, 已存在的 config_key 跳过, 不存在才插.
-- ============================================================
INSERT IGNORE INTO t_safety_config (config_key, config_group, config_value, value_type, description, is_editable) VALUES
