...
@Slf4j
@Service
public class FaceAuthUserDetailsServiceImpl implements FaceAuthUserDetailsService {
    @Autowired
    ...
    @Override
    public UserDetails loadUserByPersonId(Long personId) throws UsernameNotFoundException {
